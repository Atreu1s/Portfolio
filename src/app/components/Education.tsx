...
const educations = [
    {
        ...
        tasks: [
            ...
            'Работал в команде над проетами идей для стартапов, с дальнейшей реализацией в веб-приложениях',
        ],
    },
    {
        ...
        tasks: [
            ...
            'Участвовал в командных проектах, использовал Git для контроля версий и совместной работы',
        ],
    },
];
