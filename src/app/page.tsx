                ...
                <div className="p-6 md:p-8 border border-white/20 rounded-2xl md:border-0 md:rounded-none md:border-r-0 relative">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="py-6 mt-6">
                            Специализируюсь на проектировании архитектуры и создании безопасных, масштабируемых веб-приложений. В работе активно внедряю AI-инструменты, что позволяет автоматизировать рутину и значительно ускорять процесс разработки. <br></br><br></br>
                            Ценю командную работу и системный подход: грамотно приоритизирую задачи, чтобы стабильно соблюдать дедлайны без потери качества. <br></br><br></br>
                            Стремлюсь к реализации технически сложных и амбициозных проектов в составе сильной команды на современном технологическом стеке.
